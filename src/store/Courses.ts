  ...
  constructor() {
    ...
    this.courses = [
      new BozpCourse(
        ...
        "BOZP 1",
        true,
        new PointsRequirements(10, 20, false),
        new Classroom(createCourseTime(1, 12), "B25")
      ),
      new BozpCourse(
        2,
        "BOZP 2",
        false,
        new PointsRequirements(0, 20, false),
        new Classroom(createCourseTime(1, 12), "B25")
      ),
      new EnglishCourse(
        4,
        "FCE English",
        false,
        new FinalTestRequirements(false),
        new Remote(createCourseTime(2, 11), "www.zoom.com")
      ),
      new ProgrammingCourse(
        ...
        new Remote(createCourseTime(3, 8), "www.meeting.teams.com")
      ),
      new PublicSpeakingCourse(
        6,
        "Preparation for conferences",
        true,
        new Classroom(createCourseTime(1, 13), "A12")
      ),
      new DrawingCertification(
        7,
        "Drawing animals",
        true,
        new WorkRequirements(true, false)
      ),
      new EnglishCourse(
        10,
        "Beginner English",
        true,
        new FinalTestRequirements(false),
        new Remote(createCourseTime(5, 11), "www.zoom.com")
      ),
    ];
  }
})();
