          ...
          <Container maxWidth="lg" sx={{mt: 4, mb: 4}}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={9} lg={8}>
                <Paper
                >
                  <Typography variant="h4">Courses requiring completion</Typography>
                  <Typography variant="h5">Once prerequisites are complete, we can complete course</Typography>
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <Typography variant="h5">Itinerary of accepted courses</Typography>
                  <CoursesTimetable/>
                </Paper>
              </Grid>
            </Grid>
