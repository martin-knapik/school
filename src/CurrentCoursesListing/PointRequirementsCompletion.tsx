...
export const PointRequirementsCompletion: React.FC<PointRequirementsCompletionProps> =
  observer((props) => {
    const [newPoints, setNewPoints] = useState(
      props.course.requirements.currentPoints
    );
    return (
      <div>
        ...
        <div>
          ...
          <Button
            onClick={() =>
              props.course.requirements.setCurrentPoints(newPoints)
            }
          >
            Update
          </Button>
